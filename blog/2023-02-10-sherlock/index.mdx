...
Carapace Works With [Sherlock](https://medium.com/r?url=https%3A%2F%2Fsherlock.xyz) for Smart Contract Audit With Up to $5M Protection
Carapace Protocol will be working with Sherlock to make our contracts secure and to protect our users from capital loss due to smart contract hacking.
...
Sherlock determines if a certain smart contract hacking event is eligible for a claim based on the public-facing coverage agreement with each protocol. You can find examples [here](https://medium.com/r?url=https%3A%2F%2Fgithub.com%2Fsherlock-protocol%2Fsherlock-reports%2Ftree%2Fmain%2Fcoverage-agreements). The Carapace coverage agreement will be available at the very end of the auditing process, and it won't be too dissimilar from the example agreements above.
