    ...
    <section id='home'>
      <div className="h-screen w-screen bg-[url('.././assets/heroBanner.gif')] bg-no-repeat bg-cover bg-center">
        <div className="flex flex-col justify-center items-center h-screen">
           <h1 className="tracking-tighter font-extrabold text-white text-9xl md:text-[180px] font-manrope animate-slide-in-bottom">DeFy{" "}
            <br className='lg:hidden'/>
            <span className='tracking-[-0.02em] font-light text-7xl md:text-[150px] animate-slide-in-bottom'>DeFi Risk</span>
           </h1>
