    ...
    <section id='home'>
      <div className="h-screen w-screen bg-[url('.././assets/heroBanner.gif')] bg-no-repeat bg-cover bg-center">
        <div className="flex flex-col justify-center items-center h-screen">
          ...
          <p className='font-semibold text-white text-[30px] sm:text-[38px] leading-[34px] sm:leading-[44px] text-center tracking-[-0.02em] max-w-[300px] sm:max-w-[750px] font-manrope mt-16 mb-[79px] sm:mb-[59px]'>Invest in DeFi with protection against credit default risks.</p>
          <PinkButton
