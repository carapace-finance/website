...
<ul>
<li>1. K is a constant amount that acts like a unit.</li>
<li>2. t is the beginning time and T is the end time of protection.</li>
<li>3. is the risk factor from the premium pricing formula for this protection divided by 365.</li>
</ul>
