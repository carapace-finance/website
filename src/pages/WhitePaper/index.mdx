...
<WhitePaperLayout content={
  <section>
<h1 className="font-medium text-[24px] text-buttonPink text-opacity-60">Carapace Protocol</h1>
...
<h3 className={styles.whitePaperh3}>Insolvency</h3>

<h4 className={styles.whitePaperh4}>Leverage Ratio Floor</h4>
...
<h4 className={styles.whitePaperh4}>Incentives</h4>
...
<h4 className={styles.whitePaperh4}>Backstop Treasury Funds</h4>
...
<h4 className={styles.whitePaperh4}>CARA Token Backstop</h4>

We will reserve a portion of CARA token allocation as a backstop to cover even more loss. 

<h3 className={styles.whitePaperh3}>Frauds</h3>
...
<h4 className={styles.whitePaperh4}>Proof of Loss</h4>
...
<h3 className={styles.whitePaperh3}>Payouts Funds Source</h3>
...
<h3 className={styles.whitePaperh3}>Dispute Resolution</h3>
