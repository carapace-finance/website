...
<ul>
<li>1. <i>leverage_ratio</i> which fluctuates with changes in supply and demand in the market</li>
<li>2. <i>CURVATURE</i> which is determined  by the core team (and eventually by our community).</li>
</ul>
...
<li>3. 𝜆 is the risk factor from the premium pricing formula for this protection divided by 365.</li>
</ul>
